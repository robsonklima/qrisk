...
switch ($acao) {
    ...
    case "adicionar":
        ...
        if($object->adicionar()) {
            echo "Risk review added successfully!";

            salva_log('Risk review added', 'User Id: '.$postdata->id_usuario);
        } else { /* Failure */ }
     ...
     case "apagar":
      ...
      if($object && $object->apagar()) { echo "Risk review deleted successfully!"; } else { /* Failure */ }
