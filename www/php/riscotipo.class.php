...
class RiscoTipo extends DatabaseObject
{
    protected static $table_name = "risco_tipo";
    private $id;
    private $nome;
    private $id_status;
    ...
    {
        return self::buscar_por_sql("SELECT * FROM " . static::$table_name . " order by nome ASC");
    }
