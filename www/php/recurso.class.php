...
class Recurso extends DatabaseObject
{
    protected static $table_name = "recurso";
    private $id;
    private $nome;
    private $id_recurso_funcao;
    private $recurso_funcao_nome;
    private $id_usuario;
    private $id_status;
    ...
    public function getIdRecursoFuncao()
    {
        return $this->id_recurso_funcao;
    }
    public function setIdRecursoFuncao($id_recurso_funcao)
    {
        $this->id_recurso_funcao = $id_recurso_funcao;
    }
    ...
    public function getRecursoFuncaoNome()
    {
        return $this->recurso_funcao_nome;
    }
    
    public function adicionar() {
        global $database;
        $sql = "INSERT INTO " . static::$table_name . " (";
        $sql .= "nome, id_recurso_funcao, id_usuario, id_status";
        $sql .= ") VALUES ('";
        $sql .= $database->escape_value($this->nome)."', ";
        $sql .= $database->escape_value($this->id_recurso_funcao).", ";
    ...
    public function atualizar() {
        ...
        $sql .= " id_recurso_funcao=". $database->escape_value($this->id_recurso_funcao).",";
        $sql .= " id_usuario=". $database->escape_value($this->id_usuario).",";
    ...
    public static function buscar_todos()
    {
        return self::buscar_por_sql(" 
            SELECT      re.*
                        , rf.nome as recurso_funcao_nome
            FROM        ". static::$table_name." re
